...
const NAVS = {
  CUSTOMER: {
    ...
    items: [
      ...
      { id: 'c-fav',     to: '/favorites',            label: 'Favoriler',  icon: <Ic.Star /> },
  ...
  AGENT: {
    ...
    items: [
      ...
      { id: 'a-fav', to: '/favorites', label: 'Favoriler', icon: <Ic.Star /> },
  ...
  MANAGER: {
    ...
    items: [
      ...
      { id: 'm-fav', to: '/favorites', label: 'Favoriler', icon: <Ic.Star /> },
